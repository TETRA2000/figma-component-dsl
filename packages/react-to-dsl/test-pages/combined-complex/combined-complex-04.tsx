    ...
    <div data-testid="root" style={{ display: 'flex', flexDirection: 'row', minHeight: 400, backgroundColor: '#f5f5f5' }}>
        ...
        <div style={{ flexGrow: 1, padding: 24, display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'row', gap: 16 }}>
              <Stat value="1234" label="Users" color="#f39c12" />
              <Stat value="2468" label="Revenue" color="#f39c12" />
              <Stat value="3702" label="Orders" color="#f39c12" />
          </div>
          <Card title="Recent Activity" accentColor="#f39c12">
            <ProgressBar percent={65} color="#f39c12" />
