export default function cards_02() {
  return (
    <div data-testid="root" style={{ padding: 24, backgroundColor: '#f5f5f5' }}>
        <div style={{ backgroundColor: '#fafafa', borderRadius: 8, padding: 20, border: '1px solid #e0e0e0' }}>
          <h3 style={{ fontSize: 18, fontWeight: 600, color: '#333', marginBottom: 8 }}>Card Title 2</h3>
