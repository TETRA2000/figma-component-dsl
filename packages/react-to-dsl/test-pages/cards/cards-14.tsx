export default function cards_14() {
  return (
    <div data-testid="root" style={{ padding: 24, backgroundColor: '#f5f5f5' }}>
        <div style={{ backgroundColor: '#fff5f5', borderRadius: 16, padding: 16, border: '1px solid #e0e0e0' }}>
          <h3 style={{ fontSize: 18, fontWeight: 600, color: '#333', marginBottom: 8 }}>Card 14</h3>
          <p style={{ fontSize: 14, color: '#666', lineHeight: 1.5, marginBottom: 16 }}>Card with action buttons at the bottom.</p>
          <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
            <div style={{ backgroundColor: '#f39c12', padding: '8px 16px', borderRadius: 4 }}>
