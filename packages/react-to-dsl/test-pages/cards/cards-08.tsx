export default function cards_08() {
  return (
    <div data-testid="root" style={{ padding: 24, backgroundColor: '#f5f5f5' }}>
        <div style={{ backgroundColor: '#f8f9fa', borderRadius: 12, padding: 0, border: '1px solid #e0e0e0', overflow: 'hidden' }}>
          <div style={{ backgroundColor: '#2ecc71', height: 4, borderRadius: '12px 12px 0 0' }}>
