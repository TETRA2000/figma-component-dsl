export default function lists_grids_03() {
  return (
    <div data-testid="root" style={{ padding: 24, backgroundColor: '#f5f5f5' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <div style={{ backgroundColor: '#fff', border: '1px solid #e0e0e0', borderRadius: 8, padding: 16 }}>
            <div style={{ width: 40, height: 40, backgroundColor: '#9b59b6', borderRadius: 20, marginBottom: 8 }}>

            </div>
            <p style={{ fontSize: 14, fontWeight: 600, color: '#333' }}>Item 5</p>
            <p style={{ fontSize: 12, color: '#999', marginTop: 4 }}>Description text</p>
          </div>
          <div style={{ backgroundColor: '#fff', border: '1px solid #e0e0e0', borderRadius: 8, padding: 16 }}>
            <div style={{ width: 40, height: 40, backgroundColor: '#1abc9c', borderRadius: 20, marginBottom: 8 }}>

            </div>
            <p style={{ fontSize: 14, fontWeight: 600, color: '#333' }}>Item 6</p>
            <p style={{ fontSize: 12, color: '#999', marginTop: 4 }}>Description text</p>
          </div>
        </div>
    </div>
