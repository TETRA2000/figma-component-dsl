...
export default function lists_grids_03() {
  return (
    <div data-testid="root" style={{ padding: 24, backgroundColor: '#f5f5f5', display: 'flex', flexDirection: 'column', gap: 16 }}>
        <SectionHeader title="List 3" subtitle="List layout" />
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <FeatureItem icon="E" title="Feature 5" description="Description for feature 5" />
          <FeatureItem icon="F" title="Feature 6" description="Description for feature 6" />
        </div>
    </div>
  );
}
