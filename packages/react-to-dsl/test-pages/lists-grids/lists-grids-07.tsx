...
export default function lists_grids_07() {
  return (
    <div data-testid="root" style={{ padding: 24, backgroundColor: '#f5f5f5', display: 'flex', flexDirection: 'column', gap: 16 }}>
        <SectionHeader title="List 7" subtitle="Grid layout" />
        <div style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', gap: 16 }}>
          ...
          <div style={{ backgroundColor: '#fff', border: '1px solid #e0e0e0', borderRadius: 8, padding: 16, display: 'flex', flexDirection: 'column', gap: 8 }}>
            <Avatar color="#9b59b6" />
            <span style={{ fontSize: 14, fontWeight: 600, color: '#333' }}>Item 5</span>
            <Badge label="Tag" color="#9b59b6" />
          </div>
          <div style={{ backgroundColor: '#fff', border: '1px solid #e0e0e0', borderRadius: 8, padding: 16, display: 'flex', flexDirection: 'column', gap: 8 }}>
            <Avatar color="#1abc9c" />
            <span style={{ fontSize: 14, fontWeight: 600, color: '#333' }}>Item 6</span>
            <Badge label="Tag" color="#1abc9c" />
          </div>
        </div>
    </div>
  );
