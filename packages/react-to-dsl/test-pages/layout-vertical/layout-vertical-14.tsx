...
export default function layout_vertical_14() {
  return (
    <div data-testid="root" style={{ display: 'flex', flexDirection: 'column', gap: 16, alignItems: 'flex-end', padding: 16, backgroundColor: '#fafafa', minWidth: 200 }}>
