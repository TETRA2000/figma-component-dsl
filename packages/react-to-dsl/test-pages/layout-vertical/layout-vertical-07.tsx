...
export default function layout_vertical_07() {
  return (
    <div data-testid="root" style={{ display: 'flex', flexDirection: 'column', gap: 24, alignItems: 'flex-start', padding: 16, backgroundColor: '#fafafa', minWidth: 200 }}>
