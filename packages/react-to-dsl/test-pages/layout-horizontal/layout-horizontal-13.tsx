...
export default function layout_horizontal_13() {
  return (
    <div data-testid="root" style={{ display: 'flex', flexDirection: 'row', gap: 8, justifyContent: 'flex-start', alignItems: 'center', padding: 16, backgroundColor: '#f5f5f5', minHeight: 120 }}>
