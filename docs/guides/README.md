...
| How do I preview DSL in React and export to `.figma.json`?      | [DslCanvas to Figma Plugin JSON](dsl-canvas-to-figma-json.md) |
...
- [DslCanvas to Figma Plugin JSON](dsl-canvas-to-figma-json.md) — preview DSL in React and export to `.figma.json`
