...
- [x] 8.1 Add the HTML Preview language entry to the plugin manifest
...
- [x] 8.2 Convert the codegen dispatcher to an async callback with canvas detection
...
- [x] 8.3 Add canvas image capture to the dispatcher for HTML language requests
...
- [x] 8.4 Write unit tests for the extended dispatcher
...
- [x] 9.1 (P) Create the HTML generator that produces self-contained HTML with inline CSS
...
- [x] 9.2 (P) Add canvas image embedding to the HTML generator
...
- [x] 9.3 (P) Write unit tests for the HTML generator
...
- [x] 10.1 Add DslCanvas JSX element generation to the React generator
...
- [x] 10.2 Write unit tests for DslCanvas-aware React generation
...
- [x] 11.1 Run end-to-end integration tests for the canvas-aware codegen pipeline
...
- [x] 11.2 Verify the plugin build and confirm no regressions
