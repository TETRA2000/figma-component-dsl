...
- [ ] 1. Define canvas types and builder in dsl-core
- [ ] 1.1 Add canvas-related fields to the DslNode interface and create the CanvasProps type
...
- [ ] 1.2 Implement the canvas() builder function
...
- [ ] 1.3 Add unit tests for canvas types and builder
...
- [ ] 2. Add compiler support for canvas nodes
- [ ] 2.1 Implement canvas metadata passthrough in the compiler
...
- [ ] 2.2 Add mutual exclusivity validation for canvas and slot flags
...
- [ ] 2.3 Add unit tests for compiler canvas support
...
- [ ] 3. (P) Implement renderCanvasNodes utility in the renderer
- [ ] 3.1 Create the canvas node extraction and rendering utility
...
- [ ] 3.2 Add unit tests for renderCanvasNodes
...
- [ ] 4. (P) Add canvas support to exporter and plugin
- [ ] 4.1 Encode canvas metadata in the Figma export format
...
- [ ] 4.2 Handle canvas frames in the Figma plugin
...
- [ ] 4.3 Add canvas serialization to the plugin serializer
...
- [ ] 4.4* Add tests for exporter and plugin canvas handling
...
- [ ] 5. (P) Add CLI canvas integration
- [ ] 5.1 Extend the render command to produce per-canvas PNGs
...
- [ ] 5.2* Add tests for CLI canvas output
...
- [ ] 6. Create the Vite plugin for server-side canvas rendering
- [ ] 6.1 Implement the dev server middleware endpoint
...
- [ ] 6.2 Implement HMR support for DSL file changes
...
- [ ] 7. Build the DslCanvas React component
- [ ] 7.1 Implement the core DslCanvas component with fixed aspect ratio
...
- [ ] 7.2 Add loading, error, and fallback states
...
- [ ] 7.3 Support slot override content in DslCanvas
...
- [ ] 8.1 Create an example DSL file using canvas nodes
...
- [ ] 8.2 Verify full pipeline round-trip
...
- [ ] 8.3 Run type checks and existing test suite
