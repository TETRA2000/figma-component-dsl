...
- [ ] 1. Core type extensions for slots and component reuse
- [ ] 1.1 Add slot fields to DslNode and supporting types
...
- [ ] 1.2 Add slot and registry fields to PluginNodeDef and PluginInput
...
- [ ] 1.3 Create the `slot()` builder function
...
- [ ] 1.4 Extend the `instance()` builder with slot overrides
...
- [ ] 2. Compiler slot handling
- [ ] 2.1 Validate slot placement within components
...
- [ ] 2.2 Inject SLOT property definitions on parent components
...
- [ ] 2.3 Compile slot overrides on instance nodes
...
- [ ] 3. Exporter slot encoding
- [ ] 3.1 Encode slot metadata in the plugin node conversion
...
- [ ] 4. Plugin slot creation and instance resolution
- [ ] 4.1 Scan the Figma file for existing components
...
- [ ] 4.2 Enhance instance resolution with file-wide lookup
...
- [ ] 4.3 Create slot frames with naming convention
...
- [ ] 4.4 Implement detached-copy strategy for instance slot overrides
...
- [ ] 5. Structural hashing, component registry, and deduplication
- [ ] 5.1 (P) Build the structural hashing utility
...
- [ ] 5.2 (P) Build the component registry
...
- [ ] 5.3 Build the structural deduplicator
...
- [ ] 6. (P) Code Connect generation
- [ ] 6.1 (P) Build the Code Connect generator module
...
- [ ] 7. CLI flags and exporter integration
- [ ] 7.1 Add registry and deduplication flags to the CLI export command
...
- [ ] 7.2 Wire registry and deduplication into the exporter pipeline
...
- [ ] 8. Bidirectional slot sync
- [ ] 8.1 Add slot-aware change detection to the edit tracker
...
- [ ] 8.2 Serialize slot content changes in changesets
...
- [ ] 9. End-to-end integration and pipeline verification
- [ ] 9.1 Full pipeline integration test: DSL with slots through to plugin JSON
...
- [ ] 9.2 Deduplication integration test: page with repeated components
...
- [ ] 9.3 Registry integration test: batch export with cross-file reuse
...
- [ ] 9.4* (P) Code Connect integration test
