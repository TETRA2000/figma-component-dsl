...
- [x] 1. Define shared sync message types and changeset warning schema
- [x] 1.1 Add WebSocket message protocol types to the shared types package
...
- [x] 1.2 (P) Add changeset warning type and extend the changeset document schema
...
- [x] 2. Create the MCP server package with core infrastructure
- [x] 2.1 Set up the MCP server package in the monorepo
...
- [x] 2.2 Implement WebSocket connection management with request-response correlation
...
- [x] 2.3 Implement the component mapping registry
...
- [x] 2.4 (P) Implement the pending change notification queue
...
- [x] 3. Register MCP tools for push, pull, and status operations
- [x] 3.1 Register the push-to-figma tool
...
- [x] 3.2 Register the pull-changeset and pull-export tools
...
- [x] 3.3 (P) Register status, mapping, and notification tools
...
- [x] 4. Extend the Figma plugin with WebSocket communication
- [x] 4.1 Extract the plugin UI HTML into a separate file
...
- [x] 4.2 Add WebSocket client to the plugin UI
...
- [x] 4.3 Update the plugin manifest for network access
...
- [x] 5. Add WebSocket message handlers to the plugin
- [x] 5.1 Handle push-components messages from the MCP server
...
- [x] 5.2 Handle request-changeset and request-export messages
...
- [x] 5.3 Forward real-time change notifications via WebSocket
...
- [x] 5.4 Implement unsyncable property warning generation
...
- [x] 6. Configure MCP server discovery and create bin stub
- [x] 6.1 Create the MCP server configuration and bin entry point
...
- [x] 7. Integration testing and end-to-end validation
- [x] 7.1 Write unit tests for MCP server components
...
- [x] 7.2 Write integration tests for MCP tool flows
...
- [x]* 7.3 (P) Write plugin WebSocket communication tests
