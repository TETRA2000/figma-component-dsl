...
- [x] 1.2 (P) Set up the Python renderer package
...
- [x] 6. Python renderer — PyCairo rendering pipeline
- [x] 6.1 (P) Implement frame and shape rendering
...
- [x] 6.4 Implement image asset handling, CLI entry point, and error reporting
