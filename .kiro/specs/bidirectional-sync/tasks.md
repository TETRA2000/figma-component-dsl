...
- [ ] 1. Define shared changeset types and consolidate PluginNodeDef
- [ ] 1.1 (P) Add changeset schema types to the dsl-core package
...
- [ ] 1.2 (P) Move the canonical PluginNodeDef and PluginInput types to a shared location
...
- [ ] 2. Update plugin build configuration for workspace imports
...
- [ ] 3. Implement edit tracking with baseline snapshots
- [ ] 3.1 Implement baseline snapshot storage on import
...
- [ ] 3.2 Register the documentchange listener and implement parent-chain attribution
...
- [ ] 4. Implement node serialization and changeset computation
- [ ] 4.1 Build the Figma node-to-PluginNodeDef serializer
...
- [ ] 4.2 Implement snapshot diff and changeset generation
...
- [ ] 4.3 Implement complete DSL JSON export
...
- [ ] 5. Build the export UI in the plugin
- [ ] 5.1 Add tabbed navigation to the plugin UI
...
- [ ] 5.2 Wire the export actions to the serializer
...
- [ ] 6. (P) Create the changeset application AI skill
- [ ] 6.1 (P) Write the SKILL.md for the apply-changeset skill
...
- [ ] 7. (P) Create the visual verification AI skill
- [ ] 7.1 (P) Write the SKILL.md for the verify-changeset skill
...
- [ ] 8.1 Test the plugin round-trip flow
...
- [ ] 8.2 Create sample changeset fixtures for skill testing
...
- [ ]* 8.3 (P) Add unit tests for the diff algorithm and description generation
