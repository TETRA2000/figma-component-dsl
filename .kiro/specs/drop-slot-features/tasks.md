...
- [ ] 1. Remove slot fields from dsl-core shared types
- [ ] 1.1 Remove slot fields from DslNode, PluginNodeDef, and ComponentPropertyType
...
- [ ] 1.2 Remove slot() builder and slotOverrides from instance()
...
- [ ] 1.3 Remove slot fields from changeset types and diff logic
...
- [ ] 2. Remove slot handling from compiler
- [ ] 2.1 (P) Remove slot compilation logic and slot fields from FigmaNodeDict
...
- [ ] 3. Remove slot encoding from exporter
- [ ] 3.1 (P) Remove slot export logic and Code Connect slot generation
...
- [ ] 4. Refactor plugin canvas detection pipeline
- [ ] 4.1 Create canvas-only detector replacing the slot detector
...
- [ ] 4.2 Refactor image capture to accept canvas regions instead of slot results
...
- [ ] 4.3 Refactor export bundler to use canvas image types
...
- [ ] 5. Refactor plugin slot utilities and import/export
- [ ] 5.1 Refactor slot naming utilities to canvas equivalents
...
- [ ] 5.2 Update plugin import/export to remove slot handling
...
- [ ] 6. Add plugin UI canvas export mode toggle
- [ ] 6.1 (P) Add canvas export mode selector to the export tab
...
- [ ] 7. Wire up canvas image pipeline orchestration
- [ ] 7.1 Replace the slot image pipeline with canvas-only orchestration in the plugin core
...
- [ ] 8. Simplify DslCanvas component
- [ ] 8.1 (P) Remove slot-specific props and logic from the DslCanvas component
...
- [ ] 9.1 (P) Remove slot references from documentation and document canvas export toggle
...
- [ ] 9.2 (P) Update spec metadata for superseded specifications
...
- [ ] 10. Regression testing and validation
- [ ] 10.1 Run full test suite and type checks across all modified packages
