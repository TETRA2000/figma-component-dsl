...
- [ ] 3. Add SVG compilation and layout resolution
- [ ] 3.1 (P) Extend the compiler to handle SVG nodes
...
- [ ] 3.2 (P) Handle SVG nodes in the layout resolver
...
- [ ] 4. Implement SVG rendering with resvg-js
- [ ] 4.1 (P) Add @resvg/resvg-js dependency and SVG preloading
...
- [ ] 4.2 (P) Add SVG case to the render dispatch
...
- [ ] 5. Add SVG export and Figma plugin creation
- [ ] 5.1 Export SVG nodes to Figma plugin JSON
...
- [ ] 5.2 Create SVG nodes in the Figma plugin
...
- [ ] 6. Implement SVG identity tracking and bidirectional sync
- [ ] 6.1 Tag SVG nodes with identity metadata in the plugin
...
- [ ] 6.2 Detect and export SVG changes in changesets
...
- [ ] 6.3 Support applying SVG changesets back to source
...
- [ ] 7. Add SVG validator rules
- [ ] 7.1 (P) Create the svg-content validation rule
...
- [ ] 7.2 (P) Register the rule in validator presets
