...
- [ ] 1. Preview app scaffold and launch configuration
- [ ] 1.1 Create the preview app with Vite, React, and TypeScript configuration
...
- [ ] 1.2 Create the reference component sync script with marker-based barrel export merge
...
- [ ] 1.3 Create the `.claude/launch.json` preview server configuration
...
- [ ] 2. DSL compatibility validator package
- [ ] 2.1 Create the validator package with project scaffolding and core interfaces
...
- [ ] 2.2 (P) Implement Phase 1 file-structure validation rules
...
- [ ] 2.3 (P) Implement Phase 1 regex-based styling validation rules
...
- [ ] 2.4 Register the `validate` command in the CLI
...
- [ ] 2.5* Implement Phase 2 AST-based validation rules
...
- [ ] 3. Shared reference documents
- [ ] 3.1 (P) Create the component registry reference document
...
- [ ] 3.2 (P) Create the design token reference document
...
- [ ] 4. Landing Page Creation Skill
- [ ] 4.1 Author the Landing Page Skill with SKILL.md and supporting files
...
- [ ] 4.2 Create eval infrastructure for the Landing Page Skill
...
- [ ] 5.1 Author the Component Creation Skill with SKILL.md, templates, and supporting files
...
- [ ] 5.2 Create eval infrastructure for the Component Creation Skill
...
- [ ] 6. Figma Export Skill
- [ ] 6.1 Author the Figma Export Skill with SKILL.md, three-approach flow, and MCP pre-check
...
- [ ] 6.2 Create eval infrastructure for the Figma Export Skill
...
- [ ] 7. HTML Export Skill
- [ ] 7.1 Author the HTML Export Skill with SKILL.md and supporting files
...
- [ ] 7.2 Create eval infrastructure for the HTML Export Skill
...
- [ ] 8. Install skill-creator reference submodule
...
- [ ] 9. Skill description optimization and cross-skill integration testing
- [ ] 9.1 Run description optimization for all four skills
...
- [ ] 9.2 Validate cross-skill integration and end-to-end workflows
