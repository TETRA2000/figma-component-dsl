...
- [ ] 1. Define Banner Mode types in DSL Core
- [ ] 1.1 Add visual effect and blend mode types to the node type system
...
- [ ] 1.2 Add extended typography properties to the text style interface
...
- [ ] 1.3 Define the font declaration type for custom font loading
...
- [ ] 2. Add mode awareness to the compiler
- [ ] 2.1 Thread the mode flag through compilation options and results
...
- [ ] 2.2 Implement absolute positioning in the layout resolver for Banner Mode
...
- [ ] 3. (P) Build the font manager in the renderer
- [ ] 3.1 Register bundled fonts and resolve font families by script
...
- [ ] 3.2 Register custom fonts from declarative font declarations
...
- [ ] 3.3 Support WOFF2 font decompression
...
- [ ] 4. (P) Implement visual effects rendering
- [ ] 4.1 Render drop shadows on canvas nodes
...
- [ ] 4.2 Render layer blur using off-screen canvas compositing
...
- [ ] 4.3 Apply blend modes during node compositing
...
- [ ] 4.4 Emit warnings for Banner Mode-only properties used in standard mode
...
- [ ] 5. (P) Extend text rendering for Banner Mode typography
- [ ] 5.1 Implement text transform, stroke, and shadow for text nodes
...
- [ ] 5.2 Implement gradient fill for text nodes
...
- [ ] 7. (P) Create the Banner Mode validator preset
...
- [ ] 8. Wire Banner Mode through the CLI
- [ ] 8.1 Detect mode and read font declarations from DSL module exports
...
- [ ] 8.2 Pass mode and fonts through compile, render, and export commands
...
- [ ] 8.3 Skip React screenshot capture for Banner Mode files
...
- [ ] 9.1 Verify the full Banner Mode pipeline from DSL file to PNG and Figma JSON
...
- [ ] 9.2 Verify standard mode backward compatibility
