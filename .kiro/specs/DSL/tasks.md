...
- [ ] 1. Core image type system and builders
- [ ] 1.1 Add IMAGE node type and ImageFill to the type system
...
- [ ] 1.2 (P) Implement the image() node builder function
...
- [ ] 1.3 (P) Implement the imageFill() fill builder function
...
- [ ] 1.4* Test coverage for image builders
...
- [ ] 2. (P) Implement pure image helpers with scale mode math and format detection
...
- [ ] 3. Extend the compiler to handle IMAGE nodes and IMAGE fills
- [ ] 3.1 Add IMAGE node compilation and IMAGE fill conversion
...
- [ ] 3.2* Test coverage for compiler image handling
...
- [ ] 4. Image loading, caching, and renderer integration
- [ ] 4.1 Implement the image loader with pre-load cache and source collection
...
- [ ] 4.2 Render IMAGE nodes with scale modes, clipping, and placeholder fallback
...
- [ ] 4.3 Render IMAGE fills on existing node types
...
- [ ] 4.4* Test coverage for image loading and rendering
...
- [ ] 5. (P) Extend the exporter to embed images as base64 in plugin JSON
- [ ] 5.1 Embed image data with metadata, size checks, and error handling
...
- [ ] 5.2* Test coverage for exporter image encoding
...
- [ ] 6. (P) Implement image validation rule
...
- [ ] 7. Add CLI --asset-dir option and image path resolution
...
- [ ] 8. Implement Figma plugin IMAGE import
- [ ] 8.1 Create Figma images from embedded base64 data and apply as fills
...
- [ ] 8.2* Test coverage for plugin image import
...
- [ ] 9. Bidirectional image sync via plugin changesets
- [ ] 9.1 Serialize IMAGE fills in baseline snapshots
...
- [ ] 9.2 Detect image changes and export changesets with embedded image data
...
- [ ] 9.3 Apply image changesets to DSL and React source code
...
- [ ] 10. End-to-end pipeline integration and verification
